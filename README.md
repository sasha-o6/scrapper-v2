...
`JOIN_INTERVAL_MS` задає паузу між автоматичними вступами в канали, коли додається багато каналів за один раз. За замовчуванням використовується `4000`, щоб не впиратись у Telegram `FLOOD_WAIT`.
